...
func Test_Create_000(t *testing.T) {
	tests := []struct {
		...
		{N("foo").CreateTable(C("a").Primary(), C("b")), `CREATE TABLE foo (a TEXT NOT NULL,b TEXT,PRIMARY KEY (a))`, ``},
		...
		{N("test").CreateTable(N("a").WithType("TEXT").Primary()), "CREATE TABLE test (a TEXT NOT NULL,PRIMARY KEY (a))", ""},
		{N("test").CreateTable(N("a").WithType("TEXT").Primary(), N("b").WithType("TEXT").Primary()), "CREATE TABLE test (a TEXT NOT NULL,b TEXT NOT NULL,PRIMARY KEY (a,b))", ""},
		...
		{N("test").CreateTable(N("a").WithType("TEXT").Primary(), N("b").WithType("TEXT")).WithUnique("b"), "CREATE TABLE test (a TEXT NOT NULL,b TEXT,PRIMARY KEY (a),UNIQUE (b))", ""},
	}
